...
-- Date        : Sat May 23 13:57:53 2020
-- Host        : dell running 64-bit Ubuntu 18.04.3 LTS
-- Command     : write_vhdl -force -mode funcsim
--               /home/mason/Desktop/work/verilog-parser/tests/cod19grp9/Uncommented_old_verison/Uncommented_old_verison.srcs/sources_1/ip/pll_example/pll_example_sim_netlist.vhdl
-- Design      : pll_example
...
architecture STRUCTURE of pll_example_pll_example_clk_wiz is
  ...
  signal clk_out2_noshift_pll_example : STD_LOGIC;
...
clkout3_buf: unisim.vcomponents.BUFG
     port map (
      I => clk_out2_noshift_pll_example,
      O => clk_out2_noshift
    );
mmcm_adv_inst: unisim.vcomponents.MMCME2_ADV
    generic map(
      ...
      CLKOUT2 => clk_out2_noshift_pll_example,
...
inst: entity work.pll_example_pll_example_clk_wiz
     port map (
      ...
      clk_out1 => clk_out1,
      clk_out2 => clk_out2,
      clk_out2_noshift => clk_out2_noshift,
      locked => locked,
      reset => reset
    );
end STRUCTURE;
