...
HD_PWD='/home/mason/Desktop/work/verilog-parser/tests/cod19grp9/Uncommented_old_verison/Uncommented_old_verison.runs/blk_mem_blockrom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log blk_mem_blockrom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source blk_mem_blockrom.tcl
