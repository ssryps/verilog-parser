...
HD_PWD='/home/mason/Desktop/work/verilog-parser/tests/cod19grp9/Uncommented_old_verison/Uncommented_old_verison.runs/fifo_uart_rx_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fifo_uart_rx.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fifo_uart_rx.tcl
