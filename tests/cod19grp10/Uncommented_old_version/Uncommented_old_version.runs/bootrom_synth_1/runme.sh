...
HD_PWD='/home/mason/Desktop/work/verilog-parser/tests/cod19grp10/Uncommented_old_version/Uncommented_old_version.runs/bootrom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bootrom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bootrom.tcl
