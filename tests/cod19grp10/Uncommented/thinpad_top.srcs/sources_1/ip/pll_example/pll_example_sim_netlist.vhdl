...
-- Date        : Wed Dec 25 18:28:33 2019
-- Host        : Thinkpad-of-Luhh running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               D:/onedrive/Tsinghua/Third-A/Computer-Composition/cod19grp10/thinpad_top.srcs/sources_1/ip/pll_example/pll_example_sim_netlist.vhdl
-- Design      : pll_example
...
architecture STRUCTURE of pll_example_pll_example_clk_wiz is
  ...
  signal clk_out5_pll_example : STD_LOGIC;
  signal clk_out6_pll_example : STD_LOGIC;
...
clkout5_buf: unisim.vcomponents.BUFG
     port map (
      I => clk_out5_pll_example,
      O => clk_out5
    );
clkout6_buf: unisim.vcomponents.BUFG
     port map (
      I => clk_out6_pll_example,
      O => clk_out6
    );
plle2_adv_inst: unisim.vcomponents.PLLE2_ADV
    generic map(
      ...
      CLKOUT1_PHASE => 19.799999,
      CLKOUT2_DIVIDE => 25,
      CLKOUT2_DUTY_CYCLE => 0.500000,
      CLKOUT2_PHASE => 79.199997,
      CLKOUT3_DIVIDE => 125,
      CLKOUT3_DUTY_CYCLE => 0.500000,
      CLKOUT3_PHASE => 10.080000,
      CLKOUT4_DIVIDE => 20,
      ...
      CLKOUT4 => clk_out5_pll_example,
      CLKOUT5 => clk_out6_pll_example,
