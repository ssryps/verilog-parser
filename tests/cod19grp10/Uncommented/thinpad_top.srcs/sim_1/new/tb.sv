...
parameter BASE_RAM_INIT_FILE = "D:\\TeamLab\\thinpad_top-rev.3\\thinpad_top.srcs\\sim_1\\new\\kernel.bin"; //BaseRAM初始化文件，请修改为实际的绝对路�??
parameter EXT_RAM_INIT_FILE = "D:\\c_organization\\thinkpad_top\\1\\TeamLab\\thinpad_top-rev.3\\thinpad_top.srcs\\sim_1\\new\\kernel.bin";    //ExtRAM初始化文件，请修改为实际的绝对路�??
