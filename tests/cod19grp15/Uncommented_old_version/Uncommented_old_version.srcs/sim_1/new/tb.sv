...
//parameter BASE_RAM_INIT_FILE = "D:\\mips32lab\\mycode\\testcases\\main.bin";
//parameter EXT_RAM_INIT_FILE = "D:\\mips32lab\\mycode\\testcases\\ext.bin";

parameter BASE_RAM_INIT_FILE = "C:\\Users\\acer\\Desktop\\temp\\mips32lab\\_TEST\\kern.bin"; //BaseRAM初始化文件，请修改为实际的绝对路径
parameter EXT_RAM_INIT_FILE = "C:\\Users\\acer\\Desktop\\temp\\mips32lab\\_TEST\\ext.bin";    //ExtRAM初始化文件，请修改为实际的绝对路径
//parameter FLASH_INIT_FILE = "\\tmp\\kernel.elf";    //Flash初始化文件，请修改为实际的绝对路径
...
//        $display("base1_0[%d] = %b", i, base1.mem_array0[i]);
//        $display("base1_1[%d] = %b", i, base1.mem_array1[i]);
//        $display("base2_0[%d] = %b", i, base2.mem_array0[i]);
//        $display("base2_1[%d] = %b", i, base2.mem_array1[i]);
    end
end
...
//        $display("ext1_0[%d] = %x", i, ext1.mem_array0[i]);
//        $display("ext1_1[%d] = %x", i, ext1.mem_array1[i]);
//        $display("ext2_0[%d] = %x", i, ext2.mem_array0[i]);
//        $display("ext2_1[%d] = %x", i, ext2.mem_array1[i]);
    end
end
