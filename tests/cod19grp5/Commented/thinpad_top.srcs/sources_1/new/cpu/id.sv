...
module id(
    ...
    // set true if the next inst is a jump inst.
    ...
    // information sent to processing executing stage
...
// low 8 bits for external interruption.
// The 9-th bit denotes it's a syscall inst.
// The 10-th bit denotes it's a invalid inst.
// The 11-th bit denotes it's a trap inst.
