...
module mem(
    ...
    input wire[`RegBus] hi_i --in_signal,
    input wire[`RegBus] lo_i --in_signal,
    input wire whilo_i --in_signal,
    ...
    //from mem
    input wire[`RegBus] mem_data_i --in_signal,
    
    //LLLbit register
    input wire LLbit_i,
    
    input wire wb_LLbit_we_i -- back this.mem,
    input wire wb_LLbit_value_i -- back this.mem,
