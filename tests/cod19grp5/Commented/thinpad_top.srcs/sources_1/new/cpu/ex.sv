...
module ex(
    ...
    // whether write hi / lo when wb
    input wire[`RegBus] wb_hi_i --back this.mem,
    input wire[`RegBus] wb_lo_i --back this.mem,
    input wire wb_whilo_i --back this.mem,
    
    // whether write hi / lo when mem
    input wire[`RegBus] mem_hi_i --back this.mem,
    input wire[`RegBus] mem_lo_i --back this.mem,
    input wire mem_whilo_i --back this.mem,
    
    input wire[`DoubleRegBus] hilo_temp_i,
    input wire[1:0] cnt_i,
    
    // connected to div module
    input wire[`DoubleRegBus] div_result_i,
    input wire div_ready_i,
    
    // whether jump & link address
    input wire[`RegBus] link_address_i --in_signal,
    input wire is_in_delayslot_i --in_signal,
    
    // whether write CP0 when mem
    ...
    // connected to CP0, for reading CP0 reg
    input wire[`RegBus] cp0_reg_data_i,
    output reg[4:0] cp0_reg_read_addr_o,
    
    // to next level of pipeline
