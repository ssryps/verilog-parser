...
parameter BASE_RAM_INIT_FILE = "D:\\code\\cod19grp5\\kernel\\kernel.bin"; //BaseRAM初始化文件，请修改为实际的绝对路�?
parameter EXT_RAM_INIT_FILE = "D:\\code\\cod19grp5\\zero.bin";    //ExtRAM初始化文件，请修改为实际的绝对路�?
...
initial begin 
    ...
    for (integer i = 0; i < 1048575; i++) begin
        ext1.mem_array0[i] = 0;
        ext1.mem_array1[i] = 0;
        ext2.mem_array0[i] = 0;
        ext2.mem_array1[i] = 0;
