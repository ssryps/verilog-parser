...
// link ex_reg for MADD, MADDU, MSUB, MSUBU
...
ex ex0(
    ...
    //mem stage write cp0? for data corelation detection
    .mem_cp0_reg_we(mem_cp0_reg_we_o),
    .mem_cp0_reg_write_addr(mem_cp0_reg_write_addr_o),
    .mem_cp0_reg_data(mem_cp0_reg_data_o),
    
    //wb stage write cp0? for data corelation detection
    .wb_cp0_reg_we(wb_cp0_reg_we_i),
    .wb_cp0_reg_write_addr(wb_cp0_reg_write_addr_i),
    .wb_cp0_reg_data(wb_cp0_reg_data_i),
...
mem mem0(
    ...
    //LLLbit_i is the value of the LLbit register
    .LLbit_i(LLbit_o),
    //but may not be the latest one. 
    ...
    //whether write CP0 when wb, to check data related
    .wb_cp0_reg_we(wb_cp0_reg_we_i),
    .wb_cp0_reg_write_addr(wb_cp0_reg_write_addr_i),
    .wb_cp0_reg_data(wb_cp0_reg_data_i),
...
ctrl ctrl0(
    ...
    .flush(flush),
    .stall(stall),
    .external_mem_stall(externel_mem_stall)
);
