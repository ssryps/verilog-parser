...
HD_PWD='/home/mason/Desktop/work/verilog-parser/tests/cod19grp7/Uncommented_old_version/Uncommented_old_version.runs/blk_mem_bootrom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log blk_mem_bootrom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source blk_mem_bootrom.tcl
