...
HD_PWD='/home/mason/Desktop/work/verilog-parser/tests/cod19grp2/Uncommented_old_verison/Uncommented_old_verison.runs/tabn_axis_fifo_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tabn_axis_fifo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tabn_axis_fifo.tcl
